...
public class TestPOJOWithDocsStoredByOthers extends BasicJavaClientREST {
	...
	public void testPOJOReadDocStoredWithInvalidDataType() throws Exception {
		...
		mh.getCollections().addAll("com.marklogic.javaclient.TestPOJOWithDocsStoredByOthers$SmallArtifact/SmallArtifact.json",
				                   "com.marklogic.javaclient.TestPOJOWithDocsStoredByOthers$SmallArtifact/SmallArtifact.json");
	 ...
	 * Your class com.marklogic.javaclient.TestPOJOWithDocsStoredByOthers$SmallArtifactSuper does not have a method or field annotated with com.marklogic.client.pojo.annotation.Id
	 * 
	 */
	@Test
