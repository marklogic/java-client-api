...
public class TestPOJOWithDocsStoredByOthers extends AbstractFunctionalTest {
  ...
  public void testPOJOReadDocStoredWithInvalidContent() throws KeyManagementException, NoSuchAlgorithmException, Exception {
    ...
    String docId[] = { "com.marklogic.client.converted.TestPOJOWithDocsStoredByOthers$SmallArtifactIdInSuper/SmallArtifactIdInSuper.json" };
  ...
  public void testPOJOReadDocStoredWithNoBeanProperty() throws KeyManagementException, NoSuchAlgorithmException, Exception {
    ...
    String docId[] = { "com.marklogic.client.converted.TestPOJOWithDocsStoredByOthers$SmallArtifactIdInSuper/SmallArtifactIdInSuper.json" };
    String json1 = new String(
        "{\"com.marklogic.client.converted.TestPOJOWithDocsStoredByOthers$SmallArtifactIdInSuper\":"
  ...
  public void testPOJOReadDocStoredWithInvalidDataType() throws Exception {
    ...
    String docId[] = { "com.marklogic.client.converted.TestPOJOWithDocsStoredByOthers$SmallArtifact/SmallArtifact.json" };
    String json1 = new String(
        "{\"com.marklogic.client.converted.TestPOJOWithDocsStoredByOthers$SmallArtifact\":"
    ...
    mh.getCollections().addAll("com.marklogic.client.converted.TestPOJOWithDocsStoredByOthers$SmallArtifact/SmallArtifact.json",
        "com.marklogic.client.converted.TestPOJOWithDocsStoredByOthers$SmallArtifact/SmallArtifact.json");
   ...
   * class com.marklogic.client.converted.
  ...
  public void testPOJOWriteReadSuper() throws KeyManagementException, NoSuchAlgorithmException, Exception {
    ...
    pojoReposSmallArtifact.write(art, "com.marklogic.client.converted.TestPOJOMissingIdGetSetMethod$SmallArtifactSuper/SmallArtifactSuper.json");
