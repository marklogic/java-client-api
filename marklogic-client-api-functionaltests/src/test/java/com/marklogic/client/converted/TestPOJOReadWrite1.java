...
public class TestPOJOReadWrite1 extends AbstractFunctionalTest {
  ...
  public void testPOJOgetDocumentUri() {
    ...
    assertEquals("com.marklogic.client.converted.TestPOJOReadWrite1$StringPOJO/StringUri.json", strPojoRepo.getDocumentUri(sobj));
    ...
    assertEquals("com.marklogic.client.converted.TestPOJOReadWrite1$IntegerPOJO/-12.json", intPojoRepo.getDocumentUri(iobj));
    ...
    assertTrue(calPojoRepo.getDocumentUri(cobj).contains("com.marklogic.client.converted.TestPOJOReadWrite1$CalendarPOJO"));
    ...
    assertEquals("com.marklogic.client.converted.TestPOJOReadWrite1$DoublePOJO/2.015.json", dPojoRepo.getDocumentUri(dobj));
    ...
    assertEquals("com.marklogic.client.converted.TestPOJOReadWrite1$NumberPOJO/99.json", nPojoRepo.getDocumentUri(nobj));
  }
