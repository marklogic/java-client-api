...
public class TestPOJOReadWrite1 extends BasicJavaClientREST {
	...
	/*
	 * @Id, @JsonTypeInfo and @PathIndexProperty annotation on Calender type.
	 */
	public static class RangeQueryOnCalendar {
	    ...
	    public RangeQueryOnCalendar setName(String name) {
	        this.name = name; return this;
	    }
		public Calendar getDateId() {
			return dateId;
		}
		public RangeQueryOnCalendar setDateId(Calendar dateId) {
			this.dateId = dateId; 
			return this;
		}
	}
