...
/**
 * Search illustrates searching for documents and iterating over results.
 */
public class StringSearch {
	...
	throws IOException {
		...
		MatchDocumentSummary[] docSummaries = results.getMatchResults();
		System.out.println("Matched "+docSummaries.length+" documents:\n");
