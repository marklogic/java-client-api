...
final public class OutputCallerImpl<I,O> extends IOCallerImpl<I,O> {
    public OutputCallerImpl(
        JSONWriteHandle apiDeclaration, boolean isHandleIO, BufferableContentHandle<?,?> outputHandle
    ) {
        super(apiDeclaration, isHandleIO, null, outputHandle);
