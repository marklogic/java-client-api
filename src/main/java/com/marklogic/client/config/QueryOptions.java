 ...
 * <p>
 * Use a {@link com.marklogic.client.io.SearchOptionsHandle} as the top-level interface to 
 * QueryOptions.  The classes contained within QueryOptions implement the low-level XML binding
 * to the MarkLogic Search API, along with accessor methods to all configurable options.
 */
...
public final class QueryOptions  implements QueryAnnotations {
	...
	public static class AnyElement implements QueryOptionsItem {
		...
		public void build(QueryOptions options) {
			if (element.getLocalName().equals("searchable-expression")) {
				...
				logger.error("Unhandled element caught while building options: {}", element.getLocalName());
			}
		}
	...
	public static class Attribute extends MarkLogicQName implements
		...
		protected void innerBuild(Indexable indexable) {
	...
	public static class QueryCollection extends
			FacetableConstraintConfiguration implements QueryConstraintItem, QueryValuesItem {
	...
	public static class QueryCustom extends FacetableConstraintConfiguration
			implements QueryAnnotations, QueryConstraintItem {

		public static class FinishFacet extends XQueryExtension implements QueryCustomItem {
		...
		public static class Parse extends XQueryExtension implements QueryCustomItem {
		...
		public static class StartFacet extends XQueryExtension implements QueryCustomItem {
	...
	@XmlAccessorType(XmlAccessType.FIELD)
	public abstract static class FacetableConstraintConfiguration
	...
	@XmlAccessorType(XmlAccessType.FIELD)
	public static class Field implements QueryWordItem, QueryRangeItem, QueryValueItem, QueryValuesItem,
			IndexReference {
		...
		private void innerBuild(Indexable indexable) {
	...
	@XmlAccessorType(XmlAccessType.FIELD)
	public static class QueryGeospatialAttributePair extends
			QueryGeospatial {

	}

	@XmlAccessorType(XmlAccessType.FIELD)
	public static class QueryGeospatialElement extends
			QueryGeospatial {

	}

	@XmlAccessorType(XmlAccessType.FIELD)
	public static class QueryGeospatialElementPair extends
			QueryGeospatial {

	}

	@XmlAccessorType(XmlAccessType.FIELD)
	abstract static class QueryGeospatial
			extends BaseConstraintItem {
	...
	public static final class QueryGrammar implements QueryOptionsItem {
		...
		@XmlAccessorType(XmlAccessType.FIELD)
		public final static class QueryStarter implements QueryGrammarItem {
		...
		@XmlAccessorType(XmlAccessType.FIELD)
		public static final class QueryJoiner implements QueryGrammarItem {
	...
	@XmlAccessorType(XmlAccessType.FIELD)
	public static class Heatmap implements QueryGeospatialItem {
	...
	public final static class QueryProperties extends
			BaseConstraintItem implements QueryConstraintItem {
	...
	public static class QueryAnnotation implements QueryStateItem,
			QueryOptionsItem, QueryCustomItem {
	...
	public final static class QueryRange extends
			FacetableConstraintConfiguration implements Indexable,
			QuerySuggestionSourceItem, QueryConstraintItem, QueryValuesItem {
		 ...
		 */
		@XmlAccessorType(XmlAccessType.FIELD)
		public static class ComputedBucket implements QueryRangeItem {
	 ...
	 * <p>
	 * If a search term doesn't match a named constraint, it uses Term.  You can thus
	 * override default search behavior by changing a QueryOptions term element.
	 * 
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	public static class QueryTerm extends BaseQueryOptionConfiguration implements
			QueryOptionsItem, TermOptions, QueryAnnotations {

		/**
		 * The TermApply enumeration provides the special circumstances of an empty search string.  
		 * 
		 * {@see com.marklogic.client.config.QueryOptions.QueryTerm.getEmptyApply()}
		 * 
		 */
	...
	// have.
	public static class QueryTransformResults implements
			QueryOptionsItem {
	...
	@XmlAccessorType(XmlAccessType.FIELD)
	public final static class QueryValue extends BaseConstraintItem
			implements Indexable, QueryConstraintItem, TermOptions {
	...
	@XmlAccessorType(XmlAccessType.FIELD)
	public final static class QueryWord extends BaseConstraintItem
			implements Indexable, TermOptions, QueryConstraintItem, QueryTermItem {
	...
	@XmlAccessorType(XmlAccessType.FIELD)
	public static final class Aggregate implements QueryValuesItem {
