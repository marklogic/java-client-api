...
public class JAXBHelper {
	...
	public static <T extends JAXBBackedQueryOption> T getOneByClassName(JAXBBackedQueryOption parent, Class<T> clazz) {
	...
	public static <T extends JAXBBackedQueryOption> List<T> getByClassName(JAXBBackedQueryOption parent, Class<T> clazz) {
	...
	public static <T extends Object> List<T> getSimpleByElementName(JAXBBackedQueryOption parent, String localName) {
		List<T> l = new ArrayList<T>();
		for (Object ot : parent.getJAXBChildren()) {
			if (ot instanceof JAXBElement<?>) {
				JAXBElement<T> e = (JAXBElement<T>) ot;
				if (e.getName().equals(new QName(
	...
	public static Object getOneJAXBByElementName(
			JAXBBackedQueryOption parent, String localName) {
		List<JAXBBackedQueryOption> options = new ArrayList<JAXBBackedQueryOption>();
		for (Object ot : parent.getJAXBChildren()) {
			if (ot instanceof JAXBElement<?>) {
	...
	private static List<Object> getUnboundOptions(JAXBBackedQueryOption option, String localName) {
	...
	public static  <T extends Object> void setOneSimpleByElementName(JAXBBackedQueryOption option, String localName, T value) {
	...
	public static <T extends Object> void setSimpleByElementName(
			JAXBBackedQueryOption option, String localName,
			List<T> values) {
		List<Object> existingFlagAsList = getUnboundOptions(option, localName);
