...
public class CtsQueryExprImpl implements CtsQuery {
    ...
    @Override
        ...
        return directoryQuery(xs.strings(uris), (depth == null) ? null : xs.string(depth)); 
    }
    @Override
    ...
    @Override
        ...
        return elementAttributeValueQuery(elementName, attributeName, xs.strings(text), (options == null) ? null : xs.strings(options)); 
    }
    @Override
    ...
    @Override
        ...
        return elementAttributeValueQuery(elementName, attributeName, xs.strings(text), (options == null) ? null : xs.strings(options), xs.doubleVal(weight)); 
    }
    @Override
    ...
    @Override
        ...
        return elementWordQuery(elementName, xs.strings(text), (options == null) ? null : xs.strings(options)); 
    }
    @Override
    ...
    @Override
        ...
        return elementWordQuery(elementName, xs.strings(text), (options == null) ? null : xs.strings(options), xs.doubleVal(weight)); 
    }
    @Override
    ...
    @Override
        ...
        return fieldWordQuery(xs.strings(fieldName), xs.strings(text), (options == null) ? null : xs.strings(options)); 
    }
    @Override
    ...
    @Override
        ...
        return fieldWordQuery(xs.strings(fieldName), xs.strings(text), (options == null) ? null : xs.strings(options), xs.doubleVal(weight)); 
    }
    @Override
    ...
    @Override
        ...
        return jsonPropertyWordQuery(xs.strings(propertyName), xs.strings(text), (options == null) ? null : xs.strings(options)); 
    }
    @Override
    ...
    @Override
        ...
        return jsonPropertyWordQuery(xs.strings(propertyName), xs.strings(text), (options == null) ? null : xs.strings(options), xs.doubleVal(weight)); 
    }
    @Override
    ...
    @Override
        ...
        return wordQuery(xs.strings(text), (options == null) ? null : xs.strings(options)); 
    }
    @Override
    ...
    @Override
        ...
        return wordQuery(xs.strings(text), (options == null) ? null : xs.strings(options), xs.doubleVal(weight)); 
    }
    @Override
