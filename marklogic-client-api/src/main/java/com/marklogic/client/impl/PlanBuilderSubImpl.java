...
public class PlanBuilderSubImpl extends PlanBuilderImpl {
  public PlanBuilderSubImpl() {
	...
	public PatchBuilder patchBuilder(XsStringVal contextPath) {
		return new PatchBuilderImpl(contextPath.getString());
	}
	...
	@Override
	public PatchBuilder patchBuilder(String contextPath, Map<String, String>[] namespaces, Map<String, CtsReferenceExpr> indexes) {
		throw new UnsupportedOperationException("TODO");
	}

	@Override
	public PatchBuilder patchBuilder(XsStringVal contextPath, Map<String, String>[] namespaces, Map<String, CtsReferenceExpr> indexes) {
		throw new UnsupportedOperationException("TODO");
	}
