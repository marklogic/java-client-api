...
public class JAXBHelper {
	...
	public static JAXBBackedQueryOption newQueryOption(Object ot) {
		...
		} else if (clazz == com.marklogic.client.config.search.jaxb.ComputedBucket.class) {
			return new ComputedBucketImpl(
		...
		} else if (clazz == com.marklogic.client.config.search.jaxb.State.class) {
			return new StateImpl((com.marklogic.client.config.search.jaxb.State) ot);
	...
	public static void setOneByClassName(JAXBBackedQueryOption parent,
		...
		parent.getJAXBChildren().add(value.asJAXB());
	}
}
