 ...
 *       &lt;group ref="{http://marklogic.com/appservices/search}any-element" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "transform-results")
public class TransformResults {

    @XmlAnyElement
    protected List<Element> anyElement = new Vector<Element>();
    ...
    public List<Element> getAnyElement() {
        if (anyElement == null) {
            anyElement = new Vector<Element>();
        }
        return this.anyElement;
    }

    public boolean isSetAnyElement() {
        return ((this.anyElement!= null)&&(!this.anyElement.isEmpty()));
    }

    public void unsetAnyElement() {
        this.anyElement = null;
    }
